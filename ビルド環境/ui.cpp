...
// アニメーション用
#define TEXTURE_WIDTH_ANIM			(256 / 3)			// 選択肢サイズ
#define TEXTURE_HEIGHT_ANIM			(256 / 3)			// 選択肢サイズ

#define ANIM_POS_X					(82)				// アニメーションの配置
#define ANIM_POS_Y					(78)

#define TEXTURE_PATTERN_DIVIDE_X	(2)		// アニメパターンのテクスチャ内分割数（X)
#define TEXTURE_PATTERN_DIVIDE_Y	(1)		// アニメパターンのテクスチャ内分割数（Y)
#define ANIM_PATTERN_NUM			(TEXTURE_PATTERN_DIVIDE_X*TEXTURE_PATTERN_DIVIDE_Y)	// アニメーションパターン数
#define ANIM_WAIT					(50)		// アニメーションの切り替わるWait値
...
static char *g_TexturName[TEXTURE_MAX] = {
	...
	"data/TEXTURE/PenAnim.png",		// アニメーション用
