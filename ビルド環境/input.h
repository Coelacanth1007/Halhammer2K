...
/* game pad情報 */
#define STICK_L_UP		0x00000001l	// 方向キー上(.IY<0)
#define STICK_L_DOWN	0x00000002l	// 方向キー下(.IY>0)
#define STICK_L_LEFT	0x00000004l	// 方向キー左(.IX<0)
#define STICK_L_RIGHT	0x00000008l	// 方向キー右(.IX>0)

#define STICK_R_UP		0x00010000l	// 方向キー上(.IY<0)
#define STICK_R_DOWN	0x00020000l	// 方向キー下(.IY>0)
#define STICK_R_LEFT	0x00040000l	// 方向キー左(.IX<0)
#define STICK_R_RIGHT	0x00080000l	// 方向キー右(.IX>0)
